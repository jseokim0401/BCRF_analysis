...
# ---------------------------------------------------------------------------
# Subset to ***STR*** tissue only (from both datasets, post-merge)
# ---------------------------------------------------------------------------
table(merged_obj$tissue, merged_obj$dataset)

merged_obj <- subset(merged_obj, subset = tissue == "Str")
...
setwd("/Users/eguo/Downloads/integrated BCRF set 1-10 & EN/integrate BCRF v2_Str")
...
saveRDS(merged_obj, file = "/Users/eguo/Downloads/integrated BCRF set 1-10 & EN/integrated_BCRF_set_1-10_&_EN_v2_Str.rds")
